...
The application uses open-source Python tools including Elastic search, Langchain, llama.cpp, Streamlit and Flask. The application and logic flow as well as the architecture
